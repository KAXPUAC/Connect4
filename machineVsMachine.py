...
def MachineVsMachine():
    ...
    print('*--------------------------*\n')
    print('Antes de empezar a jugar si tiene duda de las instrucciones del juego ingrese el  siguiente comando -i o '
          '-I y si necesita ayuda ingrese el siguiente comando -h o -H')
    print("Ingrese nombre para PLAYER 1: MACHINE A")
    player1 = Player("MACHINE A", 0, 0, 0, Colors.CRED)
    print("Ingrese nombre para PLAYER 2: MACHINE B")
    player2 = Player("MACHINE B", 1, 1, 0, Colors.CGREEN)
